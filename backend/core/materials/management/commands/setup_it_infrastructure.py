...
class Command(BaseCommand):
    help = 'Setup IT Infrastructure categories and materials based on the spreadsheet'

    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('🚀 Setting up IT Infrastructure categories and materials...'))
        ...
        for mat_data in materials_data:
            ...
            if created:
                ...
                self.stdout.write(f"ℹ️  Material already exists: {material.name}")
